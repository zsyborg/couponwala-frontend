...
import { z } from "zod";
import { Eye, EyeOff, Lock, User, Mail, Smartphone, MessageSquare, ArrowRight } from "lucide-react";
...
export default function SignupPage() {
  ...
  const { registerWithOTP, sendOTP, isLoading, error, clearError } = useAuth();
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="123456"
                    maxLength={6}
                    className="flex h-10 w-full rounded-lg border border-border bg-background px-3 pl-10 py-2 text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-orange-500 text-center tracking-widest"
                    {...registerOTP("otp")}
                    onChange={(e) => {
